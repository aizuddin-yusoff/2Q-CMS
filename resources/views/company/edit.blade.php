                    ...
                    <form method="POST" action="{{ route('company.update', $company->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-9 px-4 py-3  ">
                            ...
                            <div class="">
                                ...
                                <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" :value="old('email') ?? $company->email"/>
                            ...
                            <div class="">
                                ...
                                <img class="mt-1 p-2" width="200px" src="/storage/{{ $company->logo }}">
